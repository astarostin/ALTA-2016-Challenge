...
# prepare features
data_train, data_test = prepare_features_tfidf(pairs_train, pairs_test, search_train, search_test)
...
predictor, cv_score = test_logistic_regression_cv(data_train, y)
